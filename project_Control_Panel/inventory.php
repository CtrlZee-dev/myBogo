                    ...
                    <div id="addProductForm" style="display:none;">
                        <form method="post" enctype="multipart/form-data" action="addProduct.php">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="image" name="image" style="width: 200px  " required>
                            </div>
                ...
                <div id="editProductForm" style="display:none;">
                    <form id="editProduct" method="post" enctype="multipart/form-data" action="editProduct.php">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="editImage" name="image" style="width: 200px;">
                        </div>
